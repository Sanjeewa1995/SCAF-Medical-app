...
class PressureReportList extends StatelessWidget {
  final List report;

  const PressureReportList({Key key, this.report}) : super(key: key);
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ReUseRow(
                                label: 'Pressure',
                                value:
                                    '${report[index]["pressureLevelValue"].toString()}',
                              ),
                              ReUseRow(
                                label: 'Level',
                                value:
                                    '${report[index]["pressureLevel"].toString()}',
                              ),
                              FlatButton(
                                  child: Text('Report'),
