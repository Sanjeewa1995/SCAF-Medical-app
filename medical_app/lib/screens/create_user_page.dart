...
import 'package:medical_app/screens/select_dp.dart';
...
class _CreateUserState extends State<CreateUser> {
  ...
  upload() async {
    String url = 'https://scaf.lk:610/api/controller/createmember';
            ...
            MyRaisedButton(
              ...
              onPressed: () async {
                ...
                Map<String, dynamic> data = {
                  'DateOfBirth': _bDayController.text,
                  'NationId': _nicController.text,
                  'FirstName': _firstNameController.text,
                  'LastName': _lastNameController.text,
                  'MiddleName': _middleNameController.text,
                  'SurName': _sirNameController.text,
                  'City': _cityController.text,
                  'District': _districtController.text,
                  'Address': _addressController.text,
                  'BirthPlace': _bPlaceController.text,
                  'BirthTime': _bTimeController.text,
                ...
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => SelectDp(
                      data:data
                          // sirName: _sirNameController.text,
                          // firstName: _firstNameController.text,
                          // middleName: _middleNameController.text,
                          // lastName: _lastNameController.text,
                          // userName: _userNameController.text,
                ...
                // Navigator.pushNamed(context, SelectDp.routeName,
                //     arguments: _sirNameController.text);
                print(firstName);
                print(middleName);
                print(lastName);
                print(sirName);
