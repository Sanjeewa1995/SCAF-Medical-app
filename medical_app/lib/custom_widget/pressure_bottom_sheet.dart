...
class PressureBottomSheet extends StatefulWidget {
  @override
  _PressureBottomSheetState createState() => _PressureBottomSheetState();
}

class _PressureBottomSheetState extends State<PressureBottomSheet> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  final _pressureController = TextEditingController();
  final _photoController = TextEditingController();
  FocusNode _pressureFocus = FocusNode();
  FocusNode _photoFocus = FocusNode();
                ...
                child: Column(
                  children: [
                    MyTextFormField(
                      ...
                      labelText: 'Pressure Value',
                      keyboardType: TextInputType.number,
                      focusNode: _pressureFocus,
                      textInputAction: TextInputAction.done,
                      onFieldSubmitted: (t) {
                        _pressureFocus.unfocus();
                      },
                    ),
                    MyTextFormField(
                    ...
                    MyRaisedButton(
                      ...
                      onPressed: () async {
                        ...
                        ApiResponse response = await ApiCall.dioPostRequest(
                            endPoint: 'Pressure/createpressure', data: _data);
                        _progressDialog.hide();
                        if (response.isSuccess) {
                          Navigator.of(context).pop();
                          Alerts.showMessage(context, 'Add Pressure success',
                              title: '');
                        } else {
